 ...
 */
package com.aframe.database.utils;
...
import com.aframe.database.annotate.OneToMany;
import com.aframe.database.annotate.Property;
import com.aframe.database.annotate.ManyToOne;
import com.aframe.database.annotate.Transient;
...
public class FieldUtils {
    ...
    public static Field getFieldByColumnName(Class<?> clazz, String columnName) {
        ...
        if (columnName != null) {
            ...
            if (fields != null && fields.length > 0) {
                ...
                if (field == null) {
                    for (Field f : fields) {
                        com.aframe.database.annotate.Property property = f.getAnnotation(com.aframe.database.annotate.Property.class);
                        if (property != null
    ...
    public static String getColumnByField(Field field) {
        com.aframe.database.annotate.Property property = field.getAnnotation(com.aframe.database.annotate.Property.class);
        ...
        com.aframe.database.annotate.OneToMany oneToMany = field.getAnnotation(com.aframe.database.annotate.OneToMany.class);
        if (oneToMany != null && oneToMany.manyColumn() != null
                && oneToMany.manyColumn().trim().length() != 0) {
            return oneToMany.manyColumn();
        }

        com.aframe.database.annotate.Id id = field.getAnnotation(Id.class);
    ...
    public static String getPropertyDefaultValue(Field field) {
        com.aframe.database.annotate.Property property = field.getAnnotation(Property.class);
